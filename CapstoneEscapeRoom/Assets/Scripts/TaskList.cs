    ...
    void Start()
    {
        ...
        switch (level)// task selection 
        {
            ...
            case 1: // level 1
                ...
                break;
            case 2: // level 2
                fileLines = new List<string>() { "Gain Access to Managers room", "Gain Access to Managers Computer", "Find out this information", "Gain Access to Managers Computer","Delete file X on managers computer"};
                break;
            case 3: // level 3
                fileLines = new List<string>() { };
                break;
